...
//     const handleDateChange = (_: string, dateString: string) => {
//         setFormData({
//             ...formData,
//             date: dateString
//         });
...
//     const handleTimeChange = (_: string, timeString: string) => {
//         setFormData({
//             ...formData,
//             time: timeString
//         });
...
//                                     <DatePicker className='w-full p-2' onChange={handleDateChange} />
//                                 </Form.Item>
//                                 <Form.Item label="Time">
//                                     <TimePicker needConfirm={false} className='w-full p-2' format={"HH:mm"} onChange={handleTimeChange} />
//                                 </Form.Item>
//                             </div>
//                             <div>
...
//                     {imagePreview ? <img src={imagePreview} alt="Preview" style={{ width: '90%', height: '50%' }} /> : <div className='w-[90%] h-[50%] bg-gray-200 rounded-lg flex justify-center items-center text-gray-500 text-lg'>Image Preview</div>}
//                 </div>
//             </div>
//         </>
//     );
