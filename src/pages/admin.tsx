...
const Admin: React.FC = () => {
  ...
  const [profittoggle, setprofittoggle] = useState(true);
  ...
  return (
    <>
      <div className="w-full">
        <Layout
          className="container border-red-400"
          style={{ width: "100%" }}
        >
          <Header>
            <Flex justify="space-between">
              ...
              <Flex gap="small" align="center" justify="flex-end">
               <Avatar src={<img src={imageUrl} width={100} height={100} alt="avatar" />} className="rounded-full" />
